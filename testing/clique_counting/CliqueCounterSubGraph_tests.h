#ifndef ABSTRACTIONOPTIMIZING_TEST_MINEBENCH_CLIQUECOUNTING_CLIQUECOUNTERSUBGRAPH_H
#define ABSTRACTIONOPTIMIZING_TEST_MINEBENCH_CLIQUECOUNTING_CLIQUECOUNTERSUBGRAPH_H
...
class CliqueCounterSubGraphFixture : public ::testing::Test
{
    protected:
    UCLApp ucli_;
    CLApp dcli_;
...
TEST_F(CliqueCounterSubGraphFixture, Counts2CliquesCorrect)
{
    EdgeList list(2);
    list[0] = Edge(0,1);
    list[1] = Edge(1,2);
    ...
    CliqueCounterSubGraph<NodeId> counter(2, gdir);

    ASSERT_EQ(2, counter.count(gdir));
}

TEST_F(CliqueCounterSubGraphFixture, CountsMany2CliquesCorrect)
{
    EdgeList list(5);
    list[0] = Edge(0,1);
    list[1] = Edge(1,2);
...
TEST_F(CliqueCounterSubGraphFixture, CountsNo3Clique)
{
    EdgeList list(2);
    list[0] = Edge(0,1);
    list[1] = Edge(1,2);
    ...
    CliqueCounterSubGraph<NodeId> counter(3, gdir);

    ASSERT_EQ(0, counter.count(gdir));
}

TEST_F(CliqueCounterSubGraphFixture, CountsNo3Clique2)
{
    EdgeList list(5);
    list[0] = Edge(0,1);
    list[1] = Edge(1,2);
...
TEST_F(CliqueCounterSubGraphFixture, Counts3Clique)
{
    EdgeList list(3);
    list[0] = Edge(0,1);
    list[1] = Edge(1,2);
...
TEST_F(CliqueCounterSubGraphFixture, CountsMany3CliquesCorrect)
{
    EdgeList list(12);
    list[0] = Edge(1,2);
    list[1] = Edge(2,3);
...
TEST_F(CliqueCounterSubGraphFixture, CountsNo4Clique)
{
    EdgeList list(12);
    list[0] = Edge(1,2);
    list[1] = Edge(2,3);
    ...
    CliqueCounterSubGraph<NodeId> counter(4, gdir);

    ASSERT_EQ(0, counter.count(gdir));
}

TEST_F(CliqueCounterSubGraphFixture, Counts4CliquesCorrect)
{
    EdgeList list(19);
    list[0] = Edge(0,1);
    list[1] = Edge(0,2);
...
TEST_F(CliqueCounterSubGraphFixture, Counts4CliquesCorrect2)
{
    EdgeList list(0);
