...
void benchmark_suite(BenchCLApp &cli, CGraph &g) {
    ...
    for(auto e : eps)
    {
        ...
        pipeline.SetPrintInfo("np", "kclisting", s);
        ...
        pipeline.SetPrintInfo("np", "kclisting", s2);
        ...
        pipeline.SetPrintInfo("np", "kclisting", s3);
