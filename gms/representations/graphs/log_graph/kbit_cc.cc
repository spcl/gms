...
pvector<NodeId> ShiloachVishkin(const My_Graph &g) {
...
void PrintCompStats(const My_Graph &g, const pvector<NodeId> &comp) {
  cout << endl;
...
bool CCVerifier(const My_Graph &g, const pvector<NodeId> &comp) {
